 ...
 * Header: { Authorization: Bearer <access_token> }
 */
usersRouter.get('/me', accessTokenValidator, wrapRequestHandler(getMeController)) // Cái route này dùng để xác thực người dùng có quyền vào các trang cần access_token hay không
